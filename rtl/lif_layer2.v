...
module lif_layer2(
    ...
    input wire rst,
    input wire start,
    input wire [255:0] spike_in_vec,
    input wire [7:0] wr_rd_data,
    output wire [14:0] w_rd_addr,
    output reg [127:0] spike_out_vec,
    output reg done,
...
assign w_rd_addr = neuron_idx*256 + input_idx;
...
// initial begin
//     $readmemh("/Users/neemayrajan/Documents/Project_2/data_layer/weights/weights_layer2.hex", weight_mem);
// end
